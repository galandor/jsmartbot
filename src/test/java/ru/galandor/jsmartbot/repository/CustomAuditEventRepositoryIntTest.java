...
import ru.galandor.jsmartbot.config.audit.AuditEventConverter;
import ru.galandor.jsmartbot.domain.PersistentAuditEvent;
...
import static ru.galandor.jsmartbot.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
