...
describe('Service Tests', () => {
    ...
    describe('CurrentItemMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CurrentItemMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/current-items/' + 123);
            });
            it('should return CurrentItemMySuffix', () => {

                let entity: CurrentItemMySuffix;
                service.find(123).subscribe((_entity: CurrentItemMySuffix) => {
                    entity = _entity;
                });
