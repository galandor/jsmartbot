package ru.galandor.jsmartbot.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jsmartbot");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jsmartbot");
        ...
        config.getMapConfigs().put("ru.galandor.jsmartbot.domain.*", initializeDomainMapConfig(jHipsterProperties));
